...
export class RemindersController {
  ...
  @ApiOperation({
    ...
    description:
      'Return the current reminder preference settings for the authenticated user in Supabase.',
  })
  @Get()
  ...
  @ApiOperation({
    ...
    description:
      'Partially updates the reminder preference settings for the authenticated user in Supabase.',
  })
  @Patch()
