...
export class CreateReceiptObligationDto {
  @ApiProperty({
    example: 'Woolworths',
    description:
      'Name of the new obligation, initially populated from the OCR merchant.',
  })
  @IsString()
  @MinLength(1)
  @MaxLength(120)
  ...
  @ApiProperty({
    ...
    description:
      'ID of the selected category. Defaults to the Custom category in the frontend.',
  })
  @IsUUID()
  categoryId!: string;
  ...
  @ApiProperty({
    example: '2026-09-25',
    description:
      'Start date of the obligation, initially populated from the receipt date.',
  })
  @ApiProperty({
  ...
  @ApiProperty({
    example: true,
    description:
      'User acknowledgement that the reviewed receipt information is correct.',
  })
  @IsBoolean()
