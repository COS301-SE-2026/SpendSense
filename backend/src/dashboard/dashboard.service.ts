...
export class DashboardService {
    ...
    async getDashboard(userId: string) {
        ...
        const [userSummary,creditProfile,recentScoreEvents,gamificationProfile,upcomingPayments,overduePayments,recentBadges,unreadNotifications] = await Promise.all(
            [
