...
export const RISK_CAP_REASONS = {
  ...
  CURRENT_OVERDUE_PAYMENT:
    'There is an existing overdue payment within the last 90 days',
  RECENT_LATE_15_TO_30:
    'In the last 90 days there is a later payemt ofer +14 days',
  RECENT_MISSED_PAYMENT: 'In the last 90 days there is a missed payment',
  RECENT_MISSED_CRITICAL_OBLIGATION:
    'In the last 90 days there is a missed critical obligation',
