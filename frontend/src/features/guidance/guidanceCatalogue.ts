...
export const GUIDANCE_CATALOGUE:readonly GuideCandidate[]=[
    ...
    {
        id:'payment.reward.on-time-score',
        surface:'payment',
        kind:'result',
        priority:97,
        dismissible:true,
        text:'On-time payment logged! Your credit score went up {scoreDelta} points to {scoreAfter}, and you earned {xpAwarded} XP.',
        placeholders:['scoreDelta','scoreAfter','xpAwarded'],
        eligible:(facts)=>stringEquals(facts,'paymentResult','FINAL_ON_TIME')&&numberAbove(facts,'scoreDelta',0),
    },
    {
        id:'payment.reward.on-time-xp',
        surface:'payment',
        kind:'result',
        priority:95,
        dismissible:true,
        text:'On-time payment logged! You earned {xpAwarded} XP, and paying on time keeps your credit score healthy.',
        placeholders:['xpAwarded'],
        eligible:(facts)=>stringEquals(facts,'paymentResult','FINAL_ON_TIME')&&numberAbove(facts,'xpAwarded',0),
    },
    {
        id:'obligation.created',
        surface:'payment',
        kind:'result',
        priority:94,
        dismissible:true,
        text:'New obligation added! You earned {xpAwarded} XP. Log each payment on time to grow your credit score.',
        placeholders:['xpAwarded'],
        eligible:(facts)=>isTrue(facts,'obligationJustCreated')&&numberAbove(facts,'xpAwarded',0),
    },
    {
...

    {
        ...
        priority:94,
        dismissible:true,
        text:'You and {friendName} are now friends! Compare progress on the leaderboard or challenge them to a wager.',
        placeholders:['friendName'],
        eligible:(facts)=>isTrue(facts,'friendJustAdded'),
    },
    {
        ...
        priority:93,
        dismissible:true,
        text:'Friend request sent to {friendName}! Once they accept, you can compare progress together.',
        placeholders:['friendName'],
        eligible:(facts)=>isTrue(facts,'friendRequestSent'),
    },
    {
