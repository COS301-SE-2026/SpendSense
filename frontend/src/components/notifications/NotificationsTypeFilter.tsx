    ...
    return(
        <div className="flex-1">
            ...
            <dialog
                ...
                className="fixed bottom-0 left-1/2 top-auto m-0 w-[calc(100%-2rem)] max-w-md -translate-x-1/2 rounded-t-3xl bg-white p-0 shadow-lg backdrop:bg-black/30"
            ...
            >
                <div className="pb-6 pt-3">
                    ...
                    <div className="flex items-center justify-between px-5 pb-2">
                        <h2 className="text-base font-bold text-[#091828]">
                            Filter by type
                        </h2>
...
function FilterOption({
    ...
    return(
        ...
        >
            {icon??(
                <span className="flex size-10 shrink-0 items-center justify-center rounded-full bg-[#f4fbf7]"/>
            )}
