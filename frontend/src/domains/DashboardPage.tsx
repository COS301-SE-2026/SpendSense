    ...
    return (
        ...
        <div className="mx-auto w-full max-w-md px-5 pt-6">
            ...
            <div className="flex justify-center">
                <CreditScoreGauge score={score} max={850} size="lg" />
            </div>

            <div className="mt-3 flex items-center justify-center gap-2 flex-wrap">
                <CustomBadge variant="streak" size="md">
            ...
            <div className="mt-4 flex items-center justify-between gap-3">
                <XpPill amount={30} className="shrink-0" />
            ...
            <CustomCard className="mt-6 rounded-3xl bg-white p-5 shadow-sm">
            <SectionHeader title="Coming Up" meta="3 this week" />
            ...
            <div className="mt-4 rounded-2xl bg-[#F4FBF7] p-4">
                ...
                <div className="flex-1 min-w-0">
                    <p className="text-sm font-bold text-[#091828]">Internet Service</p>
                    <div className="mt-1">
                    <CustomBadge variant="streak" size="sm">
                        BILLS DUE
                    </CustomBadge>
                    </div>
                </div>
                <p className="text-base font-extrabold text-[#ac2a5d]">R 54.00</p>
                </div>
            </div>
